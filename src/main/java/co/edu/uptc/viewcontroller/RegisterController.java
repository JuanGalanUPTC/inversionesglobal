...
import javafx.fxml.Initializable; // 🛠️ Importación necesaria
...
// 🛠️ Agregamos 'implements Initializable' para que JavaFX ejecute el método automáticamente
public class RegisterController implements Initializable {

    @FXML
    private ComboBox<String> idiomaComboBox;

    @Override // 🛠️ Es buena práctica marcarlo como Override
    ...
    // Método auxiliar que construye la fila con Imagen + Texto
...
public void togglePassword() {
    if (mostrarPasswordCheckBox.isSelected()) {
        ...
        // 3. Mantener el foco del teclado para que el usuario siga escribiendo sin interrupciones
